            ...
            <div className="stake-content py-5 px-4">
                ...
                <div className="">
                    <div className="d-flex flex-column stake-area rounded-4 p-4 pt-3 gap-4">
                        <h1 className="text-start fs-2 fw-bold text-pink text-serif" > Stake HAVEN </h1>
                        ...
                        <div className="staking-amount">
                            ...
                            <div>
                                <p className="text-start fw-semibold">Enter HAVEN Amount</p>
                                ...
                                <div className="token-buy d-flex align-items-center justify-content-between py-2 px-3">
                                    <h6 className='fw-semibold text-serif m-0'>HAVEN Balance: <span className="fw-bolder">0 ($0.00)</span></h6>
                    ...
                    <div className="d-flex py-4 px-5 gap-4 rounded-4 free-token flex-column align-items-start text-serif">
                        <div className="text-start">
                            ...
                            <p className="text-pink m-0 fs-4 fw-bold">100 HAVEN</p>
                        ...
                        <div className="text-start">
                            ...
                            <p className="text-pink m-0 fs-4 fw-bold">13 HAVEN</p>
